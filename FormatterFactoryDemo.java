...
// The first argument to the constructor specifies the default formatter to use 
// for the formatted text field. The second argument specifies the display formatter, 
// which is used when the field does not have the focus. 
// The third argument specifies the edit formatter, which is used when 
// the field has the focus. The code does not use a fourth argument, 
// but if it did, the fourth argument would specify the null formatter, 
// which is used when the field's value is null. 
// Because no null formatter is specified, the default formatter is used 
