...
public class TableSelectionDemo extends JPanel 
    ...
    public TableSelectionDemo() {
        ...
        // Lines up widgets vertically eq QVBoxLayout
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        // command comes from JCheckBox.text (Row Selection)
        // or from JRadioButtion.text (Multiple Interval Selection)
        if ("Row Selection" == command) {
            // getting value: rowCheck.isSelected()
